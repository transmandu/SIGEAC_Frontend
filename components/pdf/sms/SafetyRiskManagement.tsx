  ...
  <Page size="LETTER" style={styles.page}>
    ...
    <View
      style={[
        ...
        { height: "auto", minHeight: 40, padding: 0 },
      ]}
    >
      ...
      <View>
        {[...Array(2)].map((_, index) => (
          <View
            key={index}
            style={{ height: 12, borderTopWidth: 1, borderTopColor: "#000" }}
          />
        ))}
      </View>
    </View>
    ...
    <View
      style={[
        styles.observationContainer,
        { height: "auto", borderBottomWidth: 0 },
      ]}
    >
      ...
      {(() => {
        const count = identification.root_cause_analysis
          .split(",")
    ...
    <View style={[styles.tableRow]}>
      ...
      >
        <Text style={[styles.cellText3, styles.boldTitle]}>
          {hasResponsible(identification.mitigation_plan?.responsible, "SMS")
            ? "X"
            : ""}
        </Text>
      </View>
    ...
    <View style={[styles.tableRow, { borderBottom: 1 }]}>
      ...
      >
        <Text style={[styles.cellText3, styles.boldTitle]}>
          {hasResponsible(identification.mitigation_plan?.responsible, "AVSEC")
            ? "X"
            : ""}
        </Text>
      </View>
      ...
      >
        <Text style={[styles.cellText3, styles.boldTitle]}>
          {hasResponsible(identification.mitigation_plan?.responsible, "IT")
            ? "X"
            : ""}
        </Text>
      </View>
...
export const ThirdPage = ({
  ...
  <Page size={"LETTER"} style={styles.page}>
    ...
    <View style={[styles.tableRow, { borderBottom: 1 }]}>
      <View
        style={{ ...styles.tableCell, width: "33.33%", backgroundColor: WHITE }}
      >
        <Text style={[styles.cellText3, { textAlign: "center" }]}>
          {"\n"}
          {(() => {
            const rVoluntario = (identification as any).voluntary_report
              ?.close_date;
            const rObligatorio = (identification as any).obligatory_report
              ?.close_date;
...
export const FourthPage = () => (
  <Page size={"LETTER"} style={styles.page}>
    ...
    <View
      style={[
        styles.observationContainer,
        { paddingBottom: 220, paddingTop: 220 },
      ]}
    ></View>
