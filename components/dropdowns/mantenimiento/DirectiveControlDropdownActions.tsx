...
const DirectiveControlDropdownActions = ({ directiveControl }: { directiveControl: DirectiveControl }) => {
  ...
  const handleDelete = () => {
    deleteDirectiveControl.mutate({ id: directiveControl.id, company: selectedCompany!.slug })
    setOpenDelete(false)
  }
    ...
    <TooltipProvider delayDuration={120}>
      <>
        <DropdownMenu open={openDropdown} onOpenChange={setOpenDropdown}>
          ...
          >
            <Tooltip>
              <TooltipTrigger asChild>
                <span>
                  <DropdownMenuItem asChild className="p-0 focus:bg-transparent">
                    <Link
                      href={`/${selectedCompany?.slug}/planificacion/control_directivas/editar/${directiveControl.id}`}
              ...
              <TooltipContent>Editar control de directivas</TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              ...
              <TooltipContent>Eliminar control de directivas</TooltipContent>
            </Tooltip>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        <Dialog open={openDelete} onOpenChange={setOpenDelete}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="text-center">¿Seguro que desea eliminar el control de directivas?</DialogTitle>
              <DialogDescription className="text-center p-2 mb-0 pb-0">
                Esta acción es irreversible: se elimina el control con todas sus AD y{" "}
            ...
            <DialogFooter className="flex flex-col-reverse gap-2 md:gap-0">
              ...
              <Button
                disabled={deleteDirectiveControl.isPending}
                className="hover:bg-white hover:text-black hover:border hover:border-black transition-all"
                onClick={handleDelete}
              >
                {deleteDirectiveControl.isPending ? <Loader2 className="size-4 animate-spin" /> : <p>Confirmar</p>}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
