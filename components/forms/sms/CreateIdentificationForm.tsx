...
import { DANGER_TYPES } from "@/lib/constants/danger_type";
...
export default function CreateDangerIdentificationForm({
    ...
    const { data: locations, isLoading: isLoadingLocations } = useGetLocationsByCompany(selectedCompany?.slug);
        ...
        <Form {...form}>
            ...
            >
                <FormLabel className="text-lg text-center m-2 font-semibold">
                    1. Notificacion de Peligro
                </FormLabel>

                {/* --- CAMPOS PRINCIPALES --- */}
                <section className="flex-col gap-2 justify-center items-center rounded-lg border p-4">
                    <h3 className="font-semibold text-center">Datos del reporte</h3>
                ...
                <section className="flex-col gap-4 justify-center items-center rounded-lg border p-4">
                    <h3 className="font-semibold text-center">Datos del Peligro
                    </h3>
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    ...
                                    >
                                        ...
                                        {selectedCompany?.slug && <SelectContent>
                                            {DANGER_TYPES[selectedCompany?.slug]?.map((type) => (
