        ...
        .refine(
          (name) => {
            ...
            return !conditions.some(
              (condition) =>
                condition.name.trim().toUpperCase() === normalizedName,
            );
          },
          {
            message:
              "Esta condición ya existe. Por favor, use un nombre diferente.",
          },
        ),
  ...
  return (
    <Form {...form}>
      ...
      >
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  placeholder="EJ: Usado, reparable, etc..."
                  {...field}
                />
              </FormControl>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  className="dark:bg-black/30"
                  placeholder="Indica a que se refiere el nombre..."
                  {...field}
                />
              </FormControl>
              <FormMessage className="text-xs" />
        ...
        <Button
          variant={createCondition.isPending ? "outline" : "default"}
