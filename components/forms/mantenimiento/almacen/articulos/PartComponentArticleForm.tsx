...
export default function PartComponentArticleForm({
  ...
  const [lifeLimitCalendar, setLifeLimitCalendar] = useState<
    Date | null | undefined
  >(
    ...
    return [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            label: "Life Limit — ciclos",
            value: values.life_limit_part_cycles,
          },
          {
            label: "Life Limit — calendario",
            value: previewDate(lifeLimitCalendar),
          },
          {
            label: "Shelf Life",
        ...
        fields: [
          {
            ...
            value: values.has_documentation ? "Sí" : "No",
          },
          {
