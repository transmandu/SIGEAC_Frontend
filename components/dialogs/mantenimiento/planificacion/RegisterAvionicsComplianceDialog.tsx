...
interface RegisterAvionicsComplianceDialogProps {
  taskId: number;
  taskName: string;
...
/** Cumplimiento de UNA tarea de un equipo de aviónica (cada tarea lleva su reloj). */
export function RegisterAvionicsComplianceDialog({
  taskId,
  taskName,
  aircraftId,
  defaultHours,
  ...
  const onSubmit = async (values: FormValues) => {
    await createAvionicsCompliance.mutateAsync({
      company: selectedCompany!.slug,
      data: {
        avionics_control_task_id: taskId,
