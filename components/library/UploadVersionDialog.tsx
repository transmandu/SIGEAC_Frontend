  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-white dark:bg-[#1a1c1e] border-slate-300 dark:border-gray-800 shadow-2xl p-0 overflow-hidden outline-none">
        {/* Header */}
        <div
          className="bg-white dark:bg-gray-800/40 px-6 py-4 border-b border-slate-200 dark:border-gray-700 flex items-center gap-2"
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <div className="grid grid-cols-2 h-11 bg-slate-200 dark:bg-gray-800/50 rounded-xl p-1 border border-slate-300 dark:border-gray-800 shadow-sm">
                <button
                  ...
                  title={
                    isOriginalExpiry
                      ? "El documento base requiere vigencia obligatoria"
                      : ""
                  }
                ...
                <button
                  ...
                  title={
                    !isOriginalExpiry && !!doc?.id
                      ? "El documento base es de tipo permanente"
                      : ""
                  }
                  className={`text-[10px] font-bold rounded-lg transition-all 
                    ${requiresExpiry ? "bg-white dark:bg-gray-700 text-blue-600 shadow-md" : "text-slate-500"}
