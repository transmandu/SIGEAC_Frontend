...
export const HistoryPanel = ({
  ...
  useEffect(() => {
    if (isOpen) {
      registerTour(
        "biblioteca-versiones",
        "Historial de Versiones",
        bibliotecaVersionesSteps,
      );
    }
    return () => unregisterTour("biblioteca-versiones");
          ...
          <div className="flex flex-col gap-4">
            ...
            {versions.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 border-2 border-dashed border-slate-300 dark:border-gray-800 rounded-2xl bg-white/50">
                ...
                <p className="text-xs text-slate-500 dark:text-gray-600 font-bold uppercase tracking-tighter">
              ...
              <div
                ...
                data-tour="biblioteca-versions-timeline"
              >
                {versions.map((v) => (
                  <div
                    key={v.id}
                  ...
                  >
                    ...
                    <div className="bg-slate-50 dark:bg-white/[0.03] p-3 rounded-xl border border-slate-200 dark:border-gray-800/50">
                      ...
                      <p className="text-xs text-slate-700 dark:text-gray-300 font-medium leading-relaxed">
                        {v.change_log ||
                          "Sin descripción de cambios registrados."}
                      </p>
                    </div>
