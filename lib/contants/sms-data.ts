...
export const COMPANIES: CompanyData[] = [
    {
        key: "transmandu",
        logo: "LOGO_TMD.png",
        altLogo: "Logo de Transmandu",
        color: "color",
        border: "border-l-blue-500",
        bgColor: "bg-blue-600",
        hover: "hover:bg-blue-700",
        gradient: " bg-gradient-to-r from-blue-500/30 to-transparent lg:bg-gradient-to-r lg:from-blue-500/30 lg:to-transparent",
    },
    {
        key: "hangar74",
        logo: "LOGO_H74.png",
        altLogo: "Logo de hangar74",
        color: "color",
