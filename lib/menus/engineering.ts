...
export function buildEngineeringGroup({
  pathname,
  currentCompany,
}: MenuContext): Group {
  return {
    ...
    menus: [
      ...
      },
      {
        ...
        active: pathname.includes(
          `/${currentCompany?.slug}/ingenieria/catalogo`,
        ),
        icon: BookOpen,
        roles: ["SUPERUSER", "ENGINEERING"],
        requiresOmac: true,
        submenus: [
          {
            ...
            label: "Manuales",
            active: pathname.includes(
              `/${currentCompany?.slug}/ingenieria/catalogo/manuales`,
            ),
          },
          {
            ...
            active: pathname.includes(
              `/${currentCompany?.slug}/ingenieria/catalogo/servicios`,
            ),
          },
        ],
      },
