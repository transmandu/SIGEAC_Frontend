import { DirectiveApplicability, DirectiveAuthority, DirectiveComplianceType } from "@/types";
...
export const DIRECTIVE_APPLICABILITY_LABELS: Record<DirectiveApplicability, string> = {
...
export const DIRECTIVE_COMPLIANCE_TYPE_LABELS: Record<DirectiveComplianceType, string> = {
  ONE_TIME: "Única vez",
