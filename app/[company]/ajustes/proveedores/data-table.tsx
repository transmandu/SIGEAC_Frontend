...
import { CreateVendorDialog } from "@/components/dialogs/general/CreateVendorDialog";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2" data-tour="proveedores-new">
          <CreateVendorDialog />
        </div>
      </div>
      ...
      >
        <Table>
          ...
          <TableBody data-tour="proveedores-expand">
            {loading ? (
              <TableRow>
                <TableCell
      ...
      <div className="" data-tour="proveedores-pagination">
