...
import type { WaitingToLocateQueueArticle } from "@/types/inventory/queues";
...
export const columns: AppColumnDef<WaitingToLocateQueueArticle>[] = [
  {
    accessorKey: "batch.name",
    header: ({ column }) => (
      <Header column={column} title="Descripción" Icon={Package} />
    ),
  ...
  },
  {
    ...
    header: ({ column }) => (
      <Header column={column} title="Nro. Parte" Icon={Hash} />
    ),
  ...
  },
  {
    accessorKey: "serial",
    header: ({ column }) => (
      <Header column={column} title="Nro. Serie" Icon={Barcode} />
    ),
