...
import { GeneralArticle, Unit } from "@/types";
...
/**
 * Opciones del filtro de unidad, del catálogo de unidades: con paginación por
 * cursor la página cargada no tiene todas las que existen en el inventario.
 */
export const getUnitOptions = (units: Pick<Unit, "label">[] | undefined) => {
