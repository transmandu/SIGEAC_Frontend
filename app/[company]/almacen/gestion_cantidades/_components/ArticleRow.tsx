...
export type Article = StockAdjustmentBatch["articles"][number];
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="p-2 bg-muted rounded-md">
            <div className="font-medium text-sm">{article.part_number}</div>
            <div className="text-xs text-muted-foreground mt-0.5 flex items-center gap-1.5">
              <span>
                {article.serial
                  ? `Serial: ${article.serial}`
                  : `Lote: ${article.lot_number || "N/A"}`}
              </span>
              <span
        ...
        <div className="flex flex-col">
          ...
          <SearchableZoneSelect
            ...
            className={
              zone !== (article.zone ?? "") ? "border-blue-500 bg-blue-50" : ""
            }
          />
          <div className="text-xs text-muted-foreground text-center mt-0.5">
