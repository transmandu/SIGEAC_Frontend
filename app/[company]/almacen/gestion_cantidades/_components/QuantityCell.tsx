...
export function QuantityEditCell({ id, base, edited, onCommit }: Props) {
  ...
  // Si desde arriba cambian los edits (ej: tras guardar), se sincroniza en el
  // mismo render en vez de en un efecto.
  const [lastEdited, setLastEdited] = React.useState(edited);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-1.5">
      <Input
        ...
        inputMode="numeric"
        className={[
          "h-9 w-30 text-center tabular-nums",
          isDirty
