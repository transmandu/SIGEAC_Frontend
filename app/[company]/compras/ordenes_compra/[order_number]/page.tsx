    ...
    <ContentLayout title='Orden de Compra'>
      <div className='flex flex-col gap-y-2 mb-12'>
        <div className='flex items-center gap-2'>
          ...
          <h1 className='text-4xl font-bold text-center flex-1 text-gray-900 dark:text-white'>
      ...
      {data && (
        <Card className='max-w-5xl mx-auto'>
          <CardHeader className='flex flex-col items-center'>
            <CardTitle className='text-5xl mb-2 text-gray-900 dark:text-white'>#{order_number}</CardTitle>
          ...
          <CardContent className='flex flex-col gap-6'>
            ...
            <div className='flex flex-wrap justify-center gap-6'>
              <div className='flex flex-col items-center p-4 border rounded-lg shadow-sm min-w-[200px] flex-1 max-w-[250px]'>
                <div className='flex items-center gap-2 text-xl font-bold text-gray-700 dark:text-white mb-2'>
                  <User className="text-blue-500" /> Creado Por
                </div>
                <div className='text-center text-gray-900 dark:text-white text-lg'>{displayValue(data.created_by)}</div>
              </div>
              ...
              <div className='flex flex-col items-center p-4 border rounded-lg shadow-sm min-w-[200px] flex-1 max-w-[250px]'>
                ...
                <div className='text-center text-gray-900 dark:text-white text-lg'>{displayValue(data.vendor?.name)}</div>
              </div>
            </div>
            ...
            <div className='flex justify-center'>
              <div className='flex flex-col items-center p-6 border rounded-lg shadow-sm min-w-[320px] max-w-[700px]'>
                ...
                <div className='flex items-center gap-2 text-xl font-bold text-gray-700 dark:text-white mb-4'>
            ...
            <div className='flex flex-col items-center'>
              <div className='text-xl font-bold text-gray-700 dark:text-white mb-2'>Justificación</div>
              <div className='bg-gray-100 dark:bg-secondary p-4 rounded-lg text-center italic text-gray-900 dark:text-white max-w-3xl w-full'>
                {displayValue(data.justification, 'Pendiente de completar')}
              </div>
            </div>

          <div className='flex flex-col gap-4'>
            <h2 className='text-2xl font-bold text-center mb-2 text-gray-900 dark:text-white'>Artículos</h2>
              ...
              <div className='flex flex-wrap justify-center gap-4'>
                {data.article_purchase_order.map((article) => (
                  ...
                  >
                    ...
                    <CardContent className='flex flex-col gap-2 p-4 text-gray-900 dark:text-white text-left'>
