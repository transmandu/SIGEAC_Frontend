...
import { statusBadgeCls, formatPurchaseDate, isAeronauticalPurchaseOrder } from './_components/utils/uiHelpers';
    ...
    <ContentLayout title="Orden de Compra">
      <div className="flex flex-col gap-6">
        ...
        <PurchaseOrderCostSummary
          ...
          card={data?.card}
          isAeronautical={isAeronauticalPurchaseOrder(data?.order_number)}
        />
