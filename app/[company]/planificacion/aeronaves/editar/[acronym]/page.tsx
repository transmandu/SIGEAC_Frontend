...
export default function EditAircraftPage({ params }: { params: { acronym: string, company: string } }) {
    ...
    const transformExistingPartsToFormFormat = useCallback((apiParts: any[]): AircraftPart[] => {
        return apiParts.map(part => {
            ...
            return {
                ...
                serial: part.serial,
                brand: part.brand,
                time_since_new: Number(part.time_since_new || part.part_hours || 0),
                time_since_overhaul: Number(part.time_since_overhaul || 0),
                cycles_since_new: Number(part.cycles_since_new || part.part_cycles || 0),
                cycles_since_overhaul: Number(part.cycles_since_overhaul || 0),
    ...
    useEffect(() => {
        ...
        setAircraftData({
            ...
            flight_hours: aircraft.flight_hours?.toString() || "0",
            flight_cycles: aircraft.flight_cycles?.toString() || "0",
