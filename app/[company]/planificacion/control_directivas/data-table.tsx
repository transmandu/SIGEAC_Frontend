...
import { ShieldAlert, PlusCircle, Search, X } from "lucide-react";
...
function globalDirectiveControlFilter(row: { original: DirectiveControl }, term: string) {
...
export function DataTable<TData extends RowData>({ columns, data }: DataTableProps<TData>) {
  ...
  const table = useTable({
    ...
    globalFilterFn: globalDirectiveControlFilter as any,
    ...
    <div>
      <div className="flex items-center justify-between gap-3 py-4">
        <ActionTriggerButton asChild>
          <Link href={`/${selectedCompany?.slug}/planificacion/control_directivas/crear`}>
              ...
              <TableRow className="hover:bg-transparent">
                <TableCell colSpan={columns.length} className="h-40">
                  <div className="flex flex-col items-center justify-center gap-2 text-center">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">No se encontró ningún control de directivas</p>
