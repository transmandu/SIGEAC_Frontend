...
function globalComponentControlFilter(
  row: { original: ComponentControl },
  term: string,
) {
    ...
    <div>
      <div className="flex items-center justify-between gap-3 py-4">
        <ActionTriggerButton asChild>
          <Link
            href={`/${selectedCompany?.slug}/planificacion/control_componentes/crear`}
          >
                ...
                <TableCell colSpan={columns.length} className="h-40">
                  <div className="flex flex-col items-center justify-center gap-2 text-center">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">
                      No se encontró ningún control de componentes
                    </p>
