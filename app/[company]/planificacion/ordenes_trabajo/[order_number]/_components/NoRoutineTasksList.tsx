...
export const NonRoutineTasksList = ({ tasks }: NonRoutineTasksListProps) => {
  ...
  const [expandedNonRoutines, setExpandedNonRoutines] = useState<
                  ...
                  {isExpanded && (
                    <CardContent className="p-0 border-t">
                      <div className="p-4">
                        ...
                        <p className="text-sm">
                          {nonRoutine.action || "Sin acción especificada"}
                        </p>
                      </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {subtasks.map((subtask) => (
                              <TaskCard
                                ...
                                key={subtask.id}
                                onClick={() =>
                                  handleTaskClick(subtask, mainTask)
                                }
                                isNonRoutine
                              />
                            ))}
