...
export function EventTypesPanel({ company }: EventTypesPanelProps) {
  const { data: eventTypes = [], isLoading } =
    useGetCalendarEventTypes(company);
                  ...
                  {!type.is_system && (
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            ¿Eliminar este tipo de evento?
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            Los eventos que usen &quot;{type.label}&quot;
                            quedarán sin tipo (y sin su color). Esta acción no
                            se puede deshacer.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction
                            ...
                            onClick={() =>
                              deleteCalendarEventType.mutate({
                                id: type.id,
                                company,
                              })
                            }
