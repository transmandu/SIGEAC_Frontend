...
const CalendarServicesPage = () => {
  ...
  useEffect(() => {
    registerTour("calendario", "Calendario", calendarioSteps);
    return () => unregisterTour("calendario");
  ...
  return (
    <ContentLayout title="Calendario de Cursos">
      ...
      >
        ...
        <p className="text-muted-foreground italic text-sm">
          Aquí puede llevar un registro de los cursos registradas en el sistema.{" "}
          <br />
