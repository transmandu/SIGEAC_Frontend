...
const bulletinsData: Bulletin[] = [
  {
    id: 1,
    imageUrl: "/politica_1.jpg",
    imageAlt: "Operational Safety",
    title: "Operational Safety",
    description:
      "Fundamental principles and best practices to maintain safety in daily operations.",
  },
  {
    id: 2,
    imageUrl: "/politica_2.jpg",
    imageAlt: "Risk Management",
    title: "Risk Management",
    description:
      "Methodologies and tools to identify, evaluate and mitigate operational risks.",
  },
  {
    id: 3,
    imageUrl:
      "http://localhost:8000/storage/sms/images/obligatory/ROS_1749824010.jpg",
    imageAlt: "Emergency Procedures",
    title: "Emergency Procedures",
    description:
      "Protocols and action plans for emergency situations and crisis management.",
  },
];
