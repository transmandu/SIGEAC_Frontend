...
const SMSPage = () => {
    ...
    const currentCompany = COMPANIES.find((c) => c.key === company);
                    ...
                    <Card className="overflow-hidden border-0 shadow-lg">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="relative h-64 lg:h-full min-h-[300px]">
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_STORAGE_BASE_URL}images/sms/${currentCompany?.logo}`}
                                    alt="Logo Transmandu"
                                    fill
                                    className="object-cover"
                                    priority
                                />
                                <div className={cn("absolute inset-0", currentCompany?.gradient)} />
                            ...
                            <div className="p-6 lg:p-8 flex flex-col justify-center">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Button
                                        ...
                                        className={cn("flex items-center gap-2 text-white transition-all duration-300", currentCompany?.bgColor, currentCompany?.hover)}
                                    >
                        ...
                        <Card className="min-h-[300px] sm:min-h-[400px]">
                            ...
                            <CardContent className="space-y-3 sm:space-y-4 text-sm sm:text-base">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch transition-all duration-900 ease-out opacity-0 animate-fade-in delay-200">
                                    {/* Términos SMS */}
                                    <div
                                        className={cn("border-l-4 pl-4 flex flex-col cursor-pointer", currentCompany?.border)}
                                    ...
                                    {/* Encuestas SMS */}
                                    <div
                                        className={cn("border-l-4 pl-4 flex flex-col cursor-pointer", currentCompany?.border)} onClick={() =>
                                            router.push(
                                    ...
                                    {/* Trivia SMS */}
                                    <div
                                        className={cn("border-l-4 pl-4 cursor-pointer flex flex-col ", currentCompany?.border)}
                                        onClick={() =>
                                            router.push(
