...
export const AeronauticalSMSTabs = ({
  company,
  surveyNumbers,
}: SMSTabsProps) => {
        ...
        <div className="space-y-6">
          <div className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
                  ...
                  <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                        Una composición más amplia para presentar misión, visión
                        y principios SMS con mejor lectura y mejor
            ...
            <Card className="border-border/60 bg-linear-to-br from-muted/20 via-background to-background shadow-lg">
              <CardHeader className="space-y-2">
                <CardTitle className="text-xl">Reportes de seguridad</CardTitle>
          ...
          <Card className="border-border/60 bg-muted/20 shadow-lg">
            <CardHeader className="space-y-2">
              ...
              <p className="text-sm leading-6 text-muted-foreground">
                Principios rectores de una operación segura, justa y enfocada en
              ...
              <div className="grid grid-cols-4 gap-3 p-3">
                {companyGallery.map((image, index) => (
                  <button
                    ...
                    className={`relative h-16 overflow-hidden rounded-2xl border sm:h-20 ${
                      index === galleryIndex
