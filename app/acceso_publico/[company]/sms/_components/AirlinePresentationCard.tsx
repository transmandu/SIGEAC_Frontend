...
const AirlinePresentationCard = ({ company }: PresentationCardProps) => {
          ...
          <div className="relative h-64 lg:h-full min-h-[300px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white lg:bottom-8 lg:left-8 lg:right-auto lg:max-w-md">
              ...
              <p className="text-sm lg:text-base opacity-90 max-w-md">
                Comprometidos con la excelencia operacional y la seguridad de
                nuestros procesos
              </p>
            </div>
          </div>
...
export default AirlinePresentationCard;
