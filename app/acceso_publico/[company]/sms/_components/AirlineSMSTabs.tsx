...
export const AirlineSMSTabs = ({ company, surveyNumbers }: SMSTabsProps) => {
    ...
    <Tabs defaultValue="politicas" className="w-full">
      <TabsList className="grid h-auto w-full grid-cols-2 gap-2 p-2 lg:grid-cols-4">
        ...
        >
          ...
          <div>
            <span className="truncate text-xs sm:text-sm">Plan Respuesta</span>
          </div>
        </TabsTrigger>
      </TabsList>
          ...
          <CardContent className="space-y-3 sm:space-y-4 text-sm sm:text-base">
            ...
            <div className="pt-4 border-t transition-all duration-1000 ease-out opacity-0 animate-fade-in delay-300">
              <div className="flex justify-center">
                <Image
                  src={`${process.env.NEXT_PUBLIC_STORAGE_BASE_URL}images/sms/sms_airplane_page.png`}
